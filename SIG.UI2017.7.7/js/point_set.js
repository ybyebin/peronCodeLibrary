$(function() {
	...
	// pointSet.releaseCycle.val('');
	// pointSet.dataType.val('');
})



// var pointSet = {
// 	creatRtu: $('.create-rtu'), //新建点页面
// 	mainDisplay: $('.point-main-display'), //主页面
// 	dataType: $('.rtu-data-type'), //数据类型
// 	releaseCycle: $('.rtu-release-cycle'), //发布周期
// 	coverRelease: $('.rtu-cov-release-input'), //cov发布
// }
...
// //新建点
// $('.point-set-creat-btn').on('click', function() {
// 	pointSet.creatRtu.show();
// 	pointSet.mainDisplay.hide();
// 	InitializeCreatePoint();

// });
// //取消
// $('.return-main-btn').on('click', function() {
// 	pointSet.creatRtu.hide();
// 	pointSet.mainDisplay.show();
// });
...
// }
// 初始化新建点
function InitializeCreatePoint() {
	// $('select').val('');
	// $('input').val('');
	// $("[name=bayaxbox]:checkbox").prop("checked", false);
	// pointSet.releaseCycle.attr("disabled", "disabled") //发布周期
	// pointSet.coverRelease.val('').attr("readonly", true);

}

$('.rtu-data-type').on('change', function() {
	// console.log('查看type' + $(this).prop('value'));
	// var rel = pointSet.coverRelease;
	// if (Number($(this).prop('value')) === 5) {
	// 	rel.val('').attr("readonly", true);
	// } else {
	// 	if ($('#covfb').is(':checked')) {
	// 		rel.val('').attr("readonly", false);
	// 	} else {
	// 		rel.val('').attr("readonly", true);
	// 	}
	// }
...
// 定时发布
$('#dsfb').on('change', function() {
	// var rel = pointSet.releaseCycle;
	// if ($(this).is(':checked')) {
	// 	rel.removeAttr('disabled');
	// } else {
	// 	rel.val('1').attr("disabled", "disabled");
	// }
...
//cov发布
$('#covfb').on('change', function() {
	// console.log("查看数据:" + pointSet.dataType.prop('value'));
	// var rel = pointSet.coverRelease;
	// if ($(this).is(':checked')) {
	// 	if (Number(pointSet.dataType.prop('value')) !== 5) {
	// 		rel.val('').attr("readonly", false);
	// 	}
	// } else {
	// 	rel.val('').attr("readonly", true);

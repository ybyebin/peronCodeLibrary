...
app.post('/getSignature', function (req, res) {
	var token = 'wechat',
	appsecret = 'bfaded0e8e58e3597f5c4b46f10a93be', //你申请的
	APPID ='wxac2865fb58ff011c',//你申请的id
	url = 'http://14j9230t10.iok.la/index'//JS接口安全域名 参与签名用的
	Res = res;
//发送https get请求 获取 access_token;
https.get("https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid=wxac2865fb58ff011c&secret=bfaded0e8e58e3597f5c4b46f10a93be", function(res) {  
        var datas = [];  
        var size = 0;

...
! function(a, b) {
	...
	var c, d, e = {
		...
		f = {
			...
			config: function(a, b) {
				var d = 0;
				return a = a || {}, f.cache = e.config = c.extend(e.config, a), f.path = e.config.path || f.path, "string" == typeof a.extend && (a.extend = [a.extend]), f.use("../../css/basic/layer.css", a.extend && a.extend.length > 0 ? function g() {
					var c = a.extend;
	...
	f.prompt = function(a, b) {
		...
		e.run(), f.use("../../css/basic/layer.css")
	}()
}(window);
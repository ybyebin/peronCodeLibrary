define(function (require) {
    ...
    var lastModTime = 0;
    console.log('查看数据：'+JSON.stringify(pageParam,null,2))
    ...
    (function () {
        ...
        console.log("appid:" + pageParam.appid);
        console.log("device_id:" + pageParam.device_id);
        console.log("device_type:" + pageParam.device_type);
    ...
    function setData() {
        ...
        console.log("setData:" + JSON.stringify(device_status));
    ...
    function togglePower() {
        ...
        console.log("灯的状态status:"+device_status.services.operation_status.status);

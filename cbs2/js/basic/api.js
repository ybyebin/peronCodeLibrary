...
$('.user-changePassword').on('click', function() {
	layer.open({
		title: ['修改密码', 'font-size:18px;color:#333;background:#fff;height:50px;font-weight:bold;line-height:50px;padding-left:10px'],
		type: 1,
...
$('.user-logout').on('click', function() {
	layer.open({
		title: ['退出登录', 'font-size:18px;color:#333;background:#fff;height:50px;font-weight:bold;line-height:50px;padding-left:10px'],
		type: 1,
		skin: 'layui-primary', //加上边框
		area: ['600px', '200px'], //宽高
...
//     if (data.data > 0)
//     {
//       $('#header_alarm_count').show();
//       $('#header_alarm_count').html( data.data );
//     } else {
...
// $(document).ready(function() { 
  // update_alarm_label();
  // setInterval(update_alarm_label,2000);
// });

...
<body>
  <div class="page_weixin">
    <div class="wifi-logo">
      <img src="css_js/wifi.png"/>
    </div>
    <div class="tips">
      <ul>
        <li>1. 确定手机打开WiFi,并连接上要配置的路由</li>
        <li>2. WiFi模块上电LED亮后，请长按配置按钮</li>
        <li>3. 等待makerwakter智能水杯LED灯快闪后开始配置</li>
      </ul>
    </div>
    <div class="action">开始配置(makerwater)</div>
  </div>
  <div class="page_pc" style="text-align:center; display:none; ">
    <div class="wifi-logo">
      <img src="https://sp0.baidu.com/5aU_bSa9KgQFm2e88IuM_a/micxp1.duapp.com/qr.php?value=http%3A%2F%2Fwww.makerwifi.com%2Fairkiss.php"/>
    </div>
    <div class="tips">
      <ul>
        <li>1. 确定手机打开WiFi,并连接上要配置的路由</li>
  ...
  <div class="scan_action" style="display:none">扫描配置(makerwater)</div>
...
//    debug: false,
//    beta: true,
//    appId: 'wx1e9a89abda38241c',
//    nonceStr: 'vYrGvEhm8Nt7sb9Z',
//    signature: '16ac592f16cf007cece9eaea53177d24',
